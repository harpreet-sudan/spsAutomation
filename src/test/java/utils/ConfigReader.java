...
public class ConfigReader {
	...
	private ConfigReader() {
		...
		inputParams.put("UpdateButton_ModifyImportPath",
				config.getString("conf.InputParams.UpdateButton_ModifyImportPath"));
		...
		inputParams.put("ModifyImportPathDialogTitle",
				config.getString("conf.InputParams.ModifyImportPathDialogTitle"));
		...
		inputParams.put("partiallyFilledMenuButtonPath",
				config.getString("conf.InputParams.partiallyFilledMenuButtonPath"));
		...
		inputParams.put("completeOrderMenuButtonPath",
				config.getString("conf.InputParams.completeOrderMenuButtonPath"));
		...
		inputParams.put("ImportArchivePath", config.getString("conf.InputParams.ImportArchivePath"));
		inputParams.put("ImportDirectoryPath", config.getString("conf.InputParams.ImportDirectoryPath"));
		inputParams.put("W_Status_N", config.getString("conf.InputParams.W_Status_N"));
		inputParams.put("W_Status_A", config.getString("conf.InputParams.W_Status_A"));
		inputParams.put("FullyFilledTabButton", config.getString("conf.InputParams.FullyFilledTabButton"));
		inputParams.put("FullyFilledStatus", config.getString("conf.InputParams.FullyFilledStatus"));
		inputParams.put("RePickOrder", config.getString("conf.InputParams.RePickOrder"));
		inputParams.put("RepickOptionsWindowTitle", config.getString("conf.InputParams.RepickOptionsWindowTitle"));
		inputParams.put("ClearOrderClearCartonRepick",
				config.getString("conf.InputParams.ClearOrderClearCartonRepick"));
		inputParams.put("cancelledImagePath", config.getString("conf.InputParams.cancelledImagePath"));
		inputParams.put("UnpickedOrderTab", config.getString("conf.InputParams.UnpickedOrderTab"));

		inputParams.put("DiscardedOrderStatus", config.getString("conf.InputParams.DiscardedOrderStatus"));
